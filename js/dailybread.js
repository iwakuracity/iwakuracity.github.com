...
OpenSpending.DailyBread = function (elem) {
  ...
  this.drawIcons = function(t) {
    ...
    $('.db-area-icon', t).each(function(i,e) {
      ...
      paper.circle(iconRad,iconRad,iconRad).attr({ fill: '#0D7F18', stroke: '#0D7F18' });
      paper.circle(iconRad,iconRad,iconRad-2).attr({ fill: '#0D7F18', stroke: '#0D7F18', opacity: .8, 'stroke-dasharray': '- ' });
...
OpenSpending.renderDependentTypes = function(db) {
  function draw(iconPath, target, selected) {
    ...
    r.circle(iconRad,iconRad,iconRad).attr({ fill: '#0D7F18', stroke: 'none' });
    r.circle(iconRad,iconRad,iconRad-2).attr({ fill: '#0D7F18', stroke: '#eee', opacity: .8, 'stroke-dasharray': '- ' });
